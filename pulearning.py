...
def main(args):
    ...
    print('\nDetermining the non-redudnant known positive proteins.')
    nonredundantKnownPositives = generate_nonredundant_proteins(fastaDict, knownPositiveProteinAccessions, knownPositiveFastaFile, leafLocation, knownPositiveDirectory)
    ...
    print('\nDetermining the non-redudnant all positive dataset proteins.')
    nonredundantPositives = generate_nonredundant_proteins(fastaDict, allPositives, positiveFastaFile, leafLocation, positiveDirectory)
    ...
    print('\nDetermining the non-redudnant unlabelled dataset proteins.')
    nonredundantUnlabelleds = generate_nonredundant_proteins(fastaDict, [i for i in fastaDict if i not in allPositives], unlabelledFastaFile, leafLocation, unlabelledDirectory)
    ...
    print('\nGenerating the non-redundant known positive dataset.')
    ...
    print('\nGenerating the redundant known positive dataset.')
    ...
    print('\nGenerating the non-redundant all positive dataset.')
    ...
    print('\nGenerating the redundant all positive dataset.')
    generate_dataset(datasetDict, redundantPositives, redundantUnlabelleds, variableNames, variableTypes, varaiableCats, redundantDataset)
    ...
    likelyPositives = outputDirectory + '/UnlabelledProteinsTooSimilarToPositives.txt'
