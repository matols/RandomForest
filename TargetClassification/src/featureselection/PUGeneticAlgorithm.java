...
public class PUGeneticAlgorithm {
	...
	public static void main(String[] args)
	{
		...
		new chc.PUFeatureSelection(args, new PUTreeGrowthControl(ctrl), weights);
	 ...
	 */
	static void gaAnalysis(String inputLocation, String resultsDirLoc, PUTreeGrowthControl ctrl)
	{
