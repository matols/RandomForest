...
public class TestRunner
{
	 ...
	 */
	public void generateForestsNoCV(Map<String, Double> weights, TreeGrowthControl ctrl, String inputFile, List<Long> seeds, int numberOfForestsToCreate,
			String testFileLocation)
	{
		...
		ProcessDataForGrowing processedInputFile = new ProcessDataForGrowing(this.trainingDataset, ctrl);
		ProcessDataForGrowing processedTestFile = null;
		if (this.testDataset != null)
		{
			processedTestFile = new ProcessDataForGrowing(this.testDataset, new TreeGrowthControl());
		}
	 ...
	 * 
	 * Performs numberOfForestsToCreate rounds of cross validation with cvFolds folds, and records the confusion matrices.
	 * 
	 * @param weights - The mapping of the weights for each class in the input dataset.
	 * @param ctrl - The control object used to parse the input dataset and grow the forests.
	 ...
	 */
	public void generateForestsWithCV(Map<String, Double> weights, TreeGrowthControl ctrl, String cvFoldLocation, String inputFile, List<Long> seeds,
			int numberOfForestsToCreate, int cvFolds)
	{
		// Record the input parameters needed in the calculation of the statistics.
		this.trainingDataset = inputFile;
		this.numberOfRepetitions = numberOfForestsToCreate;
